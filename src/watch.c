...
int wbodies;	/* each bit is !=0 if want that body */
{
    ...
    {
    case WATCH_DOME:
        watch_sky (DOME_SKY, np, tminc, wbodies);
        didone = 1;
        break;
    case WATCH_ALTAZ:
        watch_sky (ALTAZ_SKY, np, tminc, wbodies);
        didone = 1;
        break;
...
char body_symbol;
{
    ...
    {
    case 'S':
        COLOR_CODE(COLOR_SUN);
        break; // black/yellow
    case 'M':
        COLOR_CODE(COLOR_MOON);
        break; // lt gray/gray
    case 'e':
        COLOR_CODE(COLOR_MERCURY);
        break; // blue/gray
    case 'v':
        COLOR_CODE(COLOR_VENUS);
        break; // black/aqua
    case 'E':
        COLOR_CODE(COLOR_EARTH);
        break; // green/blue
    case 'm':
        COLOR_CODE(COLOR_MARS);
        break; // yellow/red
    case 'j':
    case 'J':
        COLOR_CODE(COLOR_JUPITER);
        break; // aqua/red
    case 's':
        COLOR_CODE(COLOR_SATURN);
        break; // yellow/black
    case 'u':
        COLOR_CODE(COLOR_URANUS);
        break; // blue/aqua
    case 'n':
        COLOR_CODE(COLOR_NEPTUNE);
        break; // magenta/aqua
    case 'p':
        COLOR_CODE(COLOR_PLUTO);
        break; // grey/white
    case 'x':
        COLOR_CODE(COLOR_OBJX); ;
        break; // black/green
    case 'y':
        COLOR_CODE(COLOR_OBJY); ;
        break; // green/black
    }
#endif
